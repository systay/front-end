...
case class PeriodicCommitHint(size: Option[IntegerLiteral])(val position: InputPosition)(implicit override val idGen: IdGen) extends ASTNode with SemanticCheckable {
